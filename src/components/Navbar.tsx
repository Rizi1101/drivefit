        ...
        <div className="hidden md:flex items-center space-x-4">
          ...
          <form onSubmit={handleSearch} className="relative">
            <input
              ...
              className="py-1 px-3 pr-8 rounded-md border border-gray-300 focus:outline-none focus:ring-2 focus:ring-drivefit-blue focus:border-transparent"
            />
            <button 
              type="submit" 
          ...
          <div className="px-2 pt-2 pb-3 space-y-1 bg-white bg-opacity-90 backdrop-blur-md">
            <form onSubmit={handleSearch} className="relative px-3 mb-2">
              <input
                ...
                value={searchQuery}
                onChange={(e) => setSearchQuery(e.target.value)}
                className="w-full py-1 px-3 pr-8 rounded-md border border-gray-300 focus:outline-none focus:ring-2 focus:ring-drivefit-blue focus:border-transparent"
              />
              <button 
                type="submit" 
